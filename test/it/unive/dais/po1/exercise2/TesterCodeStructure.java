...
public class TesterCodeStructure {
    ...
    public void testPlayerStructure() {
        Class<? extends Player> c = ClassProvider.getPlayerCircle().getClass();
        ...
        methodsPars.put("play", new String[]{"it.unive.dais.po1.exercise2.Board"});
    ...
    public void testTicTacToeBoard() {
        Class<? extends Board> c = ClassProvider.getBoard().getClass();
        ...
        methodsReturnTypes.put("winner", "it.unive.dais.po1.exercise2.Mark");
